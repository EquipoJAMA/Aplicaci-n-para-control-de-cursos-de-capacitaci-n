    ...
    <section class="wrapper">
        <div class="row mt">
            ...
            <div class="border-head">
                <h3 id="title">Tipo de instructores</h3>
            </div>
            <section>
                <button id="btnForm" class="btn btn-success" onclick="showformTypeInstructor()" style="cursor: pointer;"><i id="faIconF" class="fa fa-plus"></i></button>
                <section>
                ...
                <div id="table" class="content-panel table table-responsive">
                    <div class="form-group col-sm-12">
                        <form action="form-horizontal" method="POST" name="search_form" id="search_form">
							...
							<div class="col-sm-10">
							    <input class="form-control" size="50" type="search" name="search" id="search" placeholder="Ingrese su busqueda" onkeyup="buscarTipoInstructor();">
							</div>
                        </form>
                    </div>
                    <div id="en_lista"></div>
