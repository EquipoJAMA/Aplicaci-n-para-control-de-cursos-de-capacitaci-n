    ...
    <section class="wrapper">
        <div class="row mt">
            ...
            <div class="border-head">
                <h3 id="title">Inscritos</h3>
            </div>
            <section>
                <button id="btnForm" class="btn btn-success" onclick="showformInscrito()" style="cursor: pointer;"><i id="faIconF" class="fa fa-plus"></i></button>
                <section>
                ...
                <div id="table" class="content-panel table table-responsive">
                    <div class="form-group col-sm-12">
                        <form action="form-horizontal" method="POST" name="search_form" id="search_form">
							...
							<div class="col-sm-4">
							    <input class="form-control" size="50" type="search" name="search" id="search" placeholder="Ingrese su busqueda" onkeyup="searchInscritos();">
                            </div>
                            <div class="col-sm-1"  style="margin-right: -5rem;">
                                <label class="control-label col-sm-1"><i class="fa fa-calendar"></i></label>
                            </div>
                            <div class="col-sm-2">
                            <select class="form-control" name="e" id="e" onchange="searchInscritos()">
