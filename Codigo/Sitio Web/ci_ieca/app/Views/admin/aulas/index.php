...
<section id="main-content">
    <section class="wrapper">
        <div class="row mt">
            ...
            <section>
                <button id="btnForm" class="btn btn-success" onclick="showformAula()" style="cursor: pointer;"><i id="faIconF" class="fa fa-plus"></i></button>
                <section>
                ...
                <div id="table" class="content-panel table table-responsive">
                    <div class="form-group col-sm-12">
                        <form action="form-horizontal" method="POST" name="search_form" id="search_form">
							...
							<div class="col-sm-4">
							    <input class="form-control" size="50" type="search" name="search" id="search" placeholder="Ingrese su busqueda" onkeyup="searchAulas();">
                            </div>
                            <div class="col-sm-1"  style="margin-right: -5rem;">
                                <label class="control-label col-sm-1"><i class="fa fa-filter"></i></label>
                            </div>
                            <div class="col-sm-3">
                                <select class="form-control" id="e" onchange="searchAulas();">
