...
<div class="col-sm-12">
    <div class="row"> 
        ...
        <div class="col-sm-12" style="margin-top: 2%; text-align: center;">
            <h2 style="position: relative; top: -250%; z-index: 2; text-shadow:0px 0px 2px #fff,
        ...
        <?php } ?>
        <div class="col-sm-12 div-imagen" style="margin-top: 2%; text-align: center;">
        <div class="col-sm-6 row px-5 d-flex align-items-center justify-content: center" style="text-align: center; margin-left: 25%; margin-right: 25%;">
